  ...
  return (
    <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
        <div>
            ...
            <p className='py-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid, minima amet. Suscipit fugit eaque asperiores et sint architecto esse hic cumque nihil? Illum, vel ipsa vitae accusantium rem quae maiores.</p>
